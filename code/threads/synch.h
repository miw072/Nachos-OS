...
//The following section define class Mailbox.
//Operations in the class Mailbox:
//Send(int message)
//Receive(*int message)
//There is a variable mailboxcount to keep track of the condition of Mailbox.
class Mailbox {
public:
...
// The following section defines a class Whale
// Operations in the class Whale:
//     getName()--return the name of the object
//     Male()--have the current thread wait until
//             there is a waiting female and matchmaker.
//     Female()--have the current thread wait until
//               there is a waiting male and matchmaker.
//     Matchmaker()--have the current thread wait until
//                   there is a waiting female and male
//
class Whale{
public:
...
private:
    char * name;
    int maleNum;    // Counter of the number of waiting males
    int femaleNum;  // Counter of the number of waiting females
    int matchNum;   // Counter of the number of waiting matchmakers
    Lock * whaleLock;
    Condition * CVmale;   // Condition variable for male
    Condition * CVfemale; // Condition variable for female
    Condition * CVmatch;  // Condition variable for matchmaker
