...
//---------------------------------------------------------------
//List::Find
//Search for a certain thread in a list, delete it in the list.
//Used for "priority inversion"
//***This method can be deleted if you meet compling error
//---------------------------------------------------------------

void
List::Find(void *item,int sortKey)
{
